...
with app.app_context():
    ...
    property1 = Property(name="Apartment 101", address="456 Elm St", description="Cozy apartment in downtown", Bedrooms=2, image="https://www.pexels.com/photo/white-high-rise-building-583516/", Size=800, RentAmount=8500, Status="Available", landlord=landlord1)
    property2 = Property(name="Apartment 102", address="45 Githurai", description="Studio apartment in downtown", Bedrooms=1, image="https://www.pexels.com/search/apartments/", Size=200, RentAmount=7500, Status="Available", landlord=landlord2)
    property3 = Property(name="Apartment 103", address="125 Rongai", description="Three bedroom villa in downtown", Bedrooms=3, image="https://www.pexels.com/photo/worm-s-eye-view-photography-of-white-concrete-building-209218/", Size=1000, RentAmount=50000, Status="Available", landlord=landlord3)
    property4 = Property(name="Apartment 104", address="8 kibera", description="apartment in uptown", Bedrooms=2, image="https://www.pexels.com/photo/white-concrete-building-3663530/", Size=800, RentAmount=30000, Status="Available", landlord=landlord2)
    property5 = Property(name="Apartment 105", address="12 Githunguri", description="Villa in uptown", Bedrooms=4, image="https://www.pexels.com/photo/white-and-brown-concrete-building-144632/", Size=1400, RentAmount=60000, Status="Available", landlord=landlord4)
    property6 = Property(name="Apartment 106", address="60 kilimani", description="Studio apartment in downtown", Bedrooms=3, image="https://www.pexels.com/photo/cozy-sofa-and-table-with-chairs-in-contemporary-living-room-6585598/", Size=1000, RentAmount=25000, Status="Available", landlord=landlord5)
    property7 = Property(name="Apartment 107", address="98 Gigiri ", description="cozy apartment in downtown", Bedrooms=3, image="https://pixabay.com/photos/building-facade-window-city-5523630/", Size=1000, RentAmount=35000, Status="Available", landlord=landlord6)
    property8 = Property(name="Apartment 108", address="134 karen", description="Houses in downtown", Bedrooms=4, image="https://www.pexels.com/photo/spacious-empty-room-with-white-walls-7031603/", Size=1400, RentAmount=70000, Status="Available", landlord=landlord7)
    property9 = Property(name="Apartment 109", address="150 kitengela", description="cozy apartment in downtown", Bedrooms=1, image="https://www.pexels.com/photo/assorted-color-wall-paint-house-photo-1370704/", Size=200, RentAmount=20000, Status="Available", landlord=landlord8)
    property10 = Property(name="Apartment 1010", address="16 imara Daima", description="Cozy apartment in downtown", Bedrooms=2, image="https://www.pexels.com/photo/blue-and-gray-concrete-house-with-attic-during-twilight-186077/", Size=800, RentAmount=25000, Status="Available", landlord=landlord9)
